...
- `doc-examples/example-java` contains executable sources used by guide
  snippets. Keep guide snippets and those example sources in sync; use tests
  there when a documentation example needs behavioral coverage.
